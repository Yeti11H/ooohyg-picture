package com.h.ooohygpicture.manager.upload;
...
//getOriginFilename：为了提取名字和后缀，确保上传后的文件有正确的扩展名
    @Override
    protected String getOriginFilename(Object inputSource) {
        String fileUrl = (String) inputSource;
        if (!fileUrl.endsWith(".png") && !fileUrl.endsWith(".jpg") && !fileUrl.endsWith(".webp")) {
            return "ai_generated_image.png"; // 👈 强制给它个名字和后缀
        }
        return FileUtil.mainName(fileUrl);
    }
//processFile：为了把“虚”的链接变成“实”的文件，这样才能上传到 COS。
    @Override
